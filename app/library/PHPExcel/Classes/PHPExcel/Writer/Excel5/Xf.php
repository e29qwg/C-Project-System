...
class PHPExcel_Writer_Excel5_Xf
{
    ...
    function writeXf()
    {
        ...
        $atr_pat = (($this->_fg_color != 0x40) || ($this->_bg_color != 0x41) || self::_mapFillType($this->_style->getFill()->getFillType())) ? 1 : 0;
